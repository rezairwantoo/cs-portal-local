            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <a href="{{ url('op-data-siswa/detail') }}" type="button" class="btn btn-secondary" style="background-color: white; color:#0E6BA8; border:none;">Kelas</a>
                        <a href="{{ url('op-data-siswa/detail-diri') }}" type="button" class="btn btn-secondary" style="background-color: #0E6BA8">Data Diri</a>
                ...
                <div class="card-body">
                    <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <x-adminlte-input name="iLabel" label="NISN" placeholder="Nisn Siswa" disable-feedback/>
                            </div>
                        </div>
                        <div class="row">
