    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <div class="col-12">
                        <form method="POST" action="{{url('bo-sekolah/add')}}" class="form-signin" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-4">
                                <x-adminlte-input name="name" label="Nama Sekolah" placeholder="Nama Sekolah" value="{{ old('name') }}"/>
                            </div>
                            <div class="col-4">
                                <x-adminlte-input name="npsn" label="NPSN Sekolah" placeholder="NPSN Sekolah" value="{{ old('npsn') }}"/>
                            </div>
                            <div class="col-4">
                                <x-adminlte-select2 label="Tingkat Sekolah" name="school_level" value="{{ old('school_level') }}">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <x-adminlte-input name="phone" label="Telepon" placeholder="Nama Sekolah" value="{{ old('phone') }}"/>
                            </div>
                            <div class="col-4">
                                <x-adminlte-input name="school_email" label="Email Sekolah" placeholder="NPSN Sekolah" value="{{ old('school_email') }}"/>
                            </div>
                            <div class="col-4">
                                <x-adminlte-input name="owner_email" label="Email Kepala Sekolah" placeholder="NPSN Sekolah" value="{{ old('owner_email') }}"/>
                            </div>
                        </div>
                        <div class="row">
