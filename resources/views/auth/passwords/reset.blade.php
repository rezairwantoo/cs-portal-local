    ...
    ">
        <div class="card card-signin" style="border: none;">
            <div class="card-body">
                ...
                <br />
                <h5 class="card-title text-center" style="color: #0077B6">Lupa Password </h5>
                <form method="POST" action="#" class="form-signin" autocomplete="off">
                    ...
                    <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
                        ...
                        <div class="input-group">
                            <a href="{{ route('login') }}" class="btn btn-lg btn-primary btn-block" style="background-color: #D81159;border-color: #D81159;">
                                {{ __('Login') }}
                            </a>
                            <br />
